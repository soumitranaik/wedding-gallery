...
import EmblaCarousel1 from "./EmblaCarousel/EmblaCarousel1";
...
const AlbumPage1 = ({ folderName, slideCount }: AlbumPageProps) => {
  ...
  return (
    ...
    >
      ...
      <EmblaCarousel1 slides={SLIDES} options={OPTIONS} folderName={folderName} />
    </div>
  );
}
export const Logo = () => {
